...
def build_arg_parser():
    ...
    options.add_argument("-p", "--port", help="Device port", default="/dev/ttyACM0", type=str)
    options.add_argument("-f", "--file", help="Firmware binary file path", required=False, type=pathlib.Path)
